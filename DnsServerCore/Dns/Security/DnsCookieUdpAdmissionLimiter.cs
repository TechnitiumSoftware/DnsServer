...
namespace DnsServerCore.Dns.Security
{
    ...
    /// It admits, drops, or slips a request; it makes no decision about the response,
    /// which has not been produced yet at this point in the request path.
    /// </summary>
    ...
    /// independent of DNS Cookie secrets and of QPM.
    /// </summary>
