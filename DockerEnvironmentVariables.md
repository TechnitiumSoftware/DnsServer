...
| DNS_SERVER_SSO_SCOPES                             | String  | A comma separated list of OpenID Connect (OIDC) scopes to request during authentication. Default scopes are `openid,profile,email,groups,roles`.
