...
{
    public class GeoCountryAddress : IDnsApplicationRequestHandler
    {
        #region variables
        ...
        { get { return "Returns A or AAAA records based on the country the client queries from using MaxMind GeoIP2 Country database."; } }
